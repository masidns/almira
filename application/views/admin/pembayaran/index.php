            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table datatable="ng" class="table table-bordered ; text-justify" id="dataTable" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr ng-repeat="item in datas" ng-class="{'bg-danger': item.bayar.dp != 0 && item.bayar.sisa==0, 'bg-success': item.bayar.lunas!=0}">
                                    <th scope="row">
                                        {{$index+1}}
                                    </th>
